    ...
    <div className="flex flex-col gap-12 w-full">
      ...
      >
        <div className="mx-auto max-w-7xl px-6 pb-20 lg:px-8">
          <div className="grid place-content-center gap-10 py-10 lg:grid-cols-2">
            <div data-aos="fade-right">
              ...
              <h1 className="mt-5 text-4xl font-bold text-slate-900 lg:text-6xl">
                Empowering Everyday Finance for Everyone.
              </h1>

              <p className="mt-5 max-w-xl text-xl font-semibold leading-7 text-slate-700">
                At Dasamonie, we believe financial services should be simple,
                inclusive, and within everyone’s reach. We’re building an
                all-in-one platform that brings together VTU services, currency
                exchange, quick loans, and POS solutions—so individuals and
                businesses can do more, faster, and securely.
              </p>
            </div>
            ...
            >
              <img
                src="/AfricaMap.png"
                alt="Africa map"
                className="h-full max-h-[31rem] w-full max-w-[28.5rem] drop-shadow-[0_12px_30px_rgba(0,0,0,0.15)] pb-20"
              />
            </div>
          </div>
        </div>
      ...
      <div className="relative z-10">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div
            className="relative h-[300px] sm:h-[360px] md:h-[420px] lg:h-[480px]
      ...
      {/* ============== Purpose ============== */}
      <section
        className="w-full max-w-full mx-auto lg:max-w-[44rem] px-6 lg:px-8"
        data-aos="fade-up"
      >
        <div className="flex flex-col gap-6 w-full">
          <div className="mb-6 flex h-12 w-12 items-start justify-start rounded-2xl shadow-2xl">
            <img
              src="/DasaIcon.png"
              alt="DasaIcon"
              className="h-full w-full object-cover"
          ...
          <p className="mt-5 text-lg leading-7 text-slate-700">
            Financial inclusion isn’t just about access to money—it’s about
            enabling people to participate fully in the economy. By breaking
            down the barriers of traditional banking, we’re creating tools that
            are simple, transparent, and tailored to everyday needs—from rural
            traders to young professionals in growing cities. Through secure
            technology and strong partnerships, we’re building a financial
            ecosystem where every Nigerian can send, receive, and manage money
            with confidence.
          </p>
        </div>
      </section>
